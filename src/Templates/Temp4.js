...
function Temp4() {
    ...
    return (
        <> 
            <div id="divTotemp4" className="temp-bg4-cert mt-3 mb-3 pb-3">
                    ...
                    <div className="row">
                        <div className="col text-center"> 
                            <EditText
                                ...
                                className="temp4-top-text"
                            />
                            <EditText
                                name="textbox1"
                                defaultValue="of appreciation"
                                className="temp4-top-sub"
                            />
                            <EditText
                                name="textbox1"
                                defaultValue="PROUDLY PRESENTED TO"
                                className="temp4-middle-text"
                            />
                            <EditText
                                id="certName"
                                name="textbox1"
                                defaultValue="Jaydip Patel"
                                className="temp4-middle-name"
                            />
                           <div style={{width:'80%', margin:'1px auto'}}>
                           <EditTextarea
                                name='description'
                                rows={2}
                                ...
                                className="temp4-description mt-2"
                            />
                           </div>
